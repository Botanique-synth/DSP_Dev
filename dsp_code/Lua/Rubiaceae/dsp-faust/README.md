...
* **0**: `/Ambient_machine/decoders/note_seq`
* **1**: `/Ambient_machine/decoders/trig_%`
* **2**: `/Ambient_machine/decoders/Exite_shape`
* **3**: `/Ambient_machine/decoders/bpm`
* **4**: `/Ambient_machine/echo/Duration`
* **5**: `/Ambient_machine/echo/Feedback`
* **6**: `/Ambient_machine/echo/disp`
* **7**: `/Ambient_machine/echo/wet`
* **8**: `/Ambient_machine/rez/Decay`
* **9**: `/Ambient_machine/rez/Hsprd`
* **10**: `/Ambient_machine/rez/freq`
* **11**: `/Ambient_machine/rez/n.o.h`
* **12**: `/Ambient_machine/rez/oddlvl`
